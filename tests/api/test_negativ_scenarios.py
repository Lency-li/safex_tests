...
class TestNegativeScenarios:
    ...
    def test_create_secret_with_invalid_secret_id(self, secret_client):
        invalid_ids = [
            "not-a-uuid",
            "12345",
    ...
    def test_create_secret_with_huge_payload(self, secret_client, test_secret_data):
        huge_content = generator.file_content_for_api(size=10 * 1024 * 1024)
    ...
    def test_malformed_json_in_register(self, opaque_client):
